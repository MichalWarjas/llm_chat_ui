					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Open Source LLMs chat",
									"targetURL": "#mwosllmchat-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"mwosllmchat-display": {
								"semanticObject": "mwosllmchat",
								"action": "display",
								"description": "Chat with different opensource llms",
								"title": "Open Source LLMs chat",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=mw.osllm.chat",
									"url": sap.ui.require.toUrl("mw/osllm/chat")
								}
							}
						}
					}
